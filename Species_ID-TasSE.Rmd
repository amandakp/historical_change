...
# Remove non-species columns before pivoting
sabund_long <- sabund %>%
  dplyr::select('Site Code', 'Faunal mid-depth.x', starts_with("Agatha"), everything()) %>%
  pivot_longer(
...
#3. VAN VEEN GRAB SAMPLES: LIVE-DEAD DISCORDANCE ANALYSIS
